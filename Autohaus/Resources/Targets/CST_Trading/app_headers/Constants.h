...
#define TABVIEW_SHOW_TESTIMONIAL                            0
...
#define TAB_BAR_ITEM_NORMAL                                 COLOR_RGB(35.0f,32.0f,33.0f)
#define TAB_BAR_ITEM_SELECTED                               COLOR_RGB(163.0f,98.0f,4.0f)
...
#define HOME_SECTION_TEXTFONT                               kFONT_HelveticaNeueMedium(18.0f)
#define HOME_SECTION_TEXTCOLOR                              [UIColor whiteColor]
#define HOME_SECTION_BARCOLOR                               COLOR_RGB(35.0f,32.0f,33.0f)
#define HOME_CELL_BGCOLOR                                   COLOR_GRAY(216.0f)
#define HOME_CELL_BORDERCOLOR                               COLOR_GRAY(230.0f)
#define HOME_CELL_TEXTFONT                                  kFONT_HelveticaNeueMedium(16.0f)
#define HOME_CELL_TEXTCOLOR                                 COLOR_RGB(35.0f,32.0f,33.0f)
#define HOME_CELL_CORNER                                    6.0f

#define SHOP_SECTION_BGCOLOR                                COLOR_GRAY(230.0f)
#define SHOP_SECTION_BORDERCOLOR                            COLOR_GRAY(216.0f)
#define SHOP_SECTION_CORNER                                 6.0f
#define SHOP_SECTION_CELL_FONT                              kFONT_HelveticaNeueMedium(18.0f)
#define SHOP_SECTION_CELL_COLOR                             COLOR_RGB(35.0f,32.0f,33.0f)
...
#define SHOP_ITEM_NAME_COLOR                                COLOR_RGB(35.0f,32.0f,33.0f)
#define SHOP_ITEM_PRICE_FONT                                kFONT_HelveticaNeueLight(16.0f)
#define SHOP_ITEM_PRICE_COLOR                               COLOR_GRAY(63.0f)

#define SHOP_ITEM_DESC_TITLEFONT                            kFONT_HelveticaNeueBold(18.0f)
#define SHOP_ITEM_DESC_TITLECOLOR                           COLOR_RGB(35.0f,32.0f,33.0f)
#define SHOP_ITEM_DESC_PRICEFONT                            kFONT_HelveticaNeueLight(18.0f)
#define SHOP_ITEM_DESC_PRICECOLOR                           COLOR_RGB(163.0f,98.0f,4.0f)
#define SHOP_ITEM_DESC_TEXTFONT                             kFONT_HelveticaNeue(18.0f)
#define SHOP_ITEM_DESC_TEXTCOLOR                            COLOR_RGB(35.0f,32.0f,33.0f)
#define SHOP_ITEM_DESC_ACTIONBOX                            COLOR_GRAY(247.0f)
#define SHOP_ITEM_DESC_ADDCARTBTNCOLOR                      COLOR_RGB(35.0f,32.0f,33.0f)
#define SHOP_ITEM_DESC_ADDCARTBTNFONT                       kFONT_HelveticaNeueBold(20.0f)
#define SHOP_ITEM_DESC_ADDCARTBTNTXTCLR                     [UIColor whiteColor]
#define SHOP_ITEM_DESC_INQUIREBTNCOLOR                      COLOR_RGB(35.0f,32.0f,33.0f)
#define SHOP_ITEM_DESC_INQUIREBTNFONT                       kFONT_HelveticaNeueBold(20.0f)
...
#define SHOP_ADDCART_NAME_COLOR                             COLOR_RGB(35.0f,32.0f,33.0f)
#define SHOP_ADDCART_PRICE_FONT                             kFONT_HelveticaNeueLight(16.0f)
#define SHOP_ADDCART_PRICE_COLOR                            COLOR_RGB(35.0f,32.0f,33.0f)
#define SHOP_ADDCART_QTYLABEL_FONT                          kFONT_HelveticaNeueMedium(16.0f)
#define SHOP_ADDCART_QTYLABEL_COLOR                         COLOR_RGB(35.0f,32.0f,33.0f)
...
#define TESTIMONIAL_NAME_FONT                               kFONT_HelveticaNeueBold(16.0f)
...
#define MORE_SECTION_FONT                                   kFONT_HelveticaNeueBold(18.0f)
#define MORE_SECTION_COLOR                                  [UIColor whiteColor]
#define MORE_SECTION_BAR_COLOR                              COLOR_RGB(35.0f,32.0f,33.0f)
...
#define CONTACTUS_BUBBLETITLEFONT                           kFONT_HelveticaNeueMedium(22.0f)
#define CONTACTUS_BUBBLESUBTITLEFONT                        kFONT_HelveticaNeueLight(16.0f)
...
#define ABOUTUS_CONTENTFONT                                 kFONT_HelveticaNeue(16.0f)
